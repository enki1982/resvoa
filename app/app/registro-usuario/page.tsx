      ...
      if (authData.user) {
        ...
        if (needsEmailConfirmation) {
          ...
          toast({
            ...
            description:
              "Te hemos enviado un enlace de confirmación. Por favor verifica tu correo.",
          });
        } else {
          try {
            await supabase.from("users").insert({
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <Link href="/" className="inline-flex items-center space-x-2 mb-4">
            ...
            <span className="font-bold text-xl text-gray-900">Resvoa</span>
          </Link>
          <h1 className="text-2xl font-bold text-gray-900">Registro de usuario</h1>
          <p className="text-gray-600 mt-1">Crea tu cuenta para empezar a recibir ayuda</p>
        </div>
